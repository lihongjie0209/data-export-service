...
import (
	...
	"github.com/lihongjie0209/data-export-service/internal/logging"
	"github.com/lihongjie0209/data-export-service/internal/migration"
	...
	"github.com/lihongjie0209/data-export-service/internal/scheduler"
	grpctransport "github.com/lihongjie0209/data-export-service/internal/transport/grpc"
	httptransport "github.com/lihongjie0209/data-export-service/internal/transport/http"
...
func newPipeline(provider platformexport.Provider, storage objectstorage.Storage, cfg config.Config) *platformexport.Pipeline {
	return platformexport.NewPipeline(provider, storage, cfg.Export.BatchSize, cfg.Export.MaxRows, cfg.Export.MaxBytes, cfg.Export.ProgressEvery)
}
func newWorker(repository platformexport.Repository, transactor *database.Transactor, pipeline *platformexport.Pipeline, storage objectstorage.Storage, cfg config.Config) *platformexport.Worker {
