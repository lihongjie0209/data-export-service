...
func TestMetadataStreamInterceptorPropagatesAuthenticationAndCorrelation(t *testing.T) {
	...
	_, err := interceptor(ctx, &grpc.StreamDesc{}, nil, "/platform.export.v1.ExportProviderService/Export", func(streamCtx context.Context, _ *grpc.StreamDesc, _ *grpc.ClientConn, _ string, _ ...grpc.CallOption) (grpc.ClientStream, error) {
