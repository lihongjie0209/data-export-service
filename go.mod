module github.com/lihongjie0209/data-export-service
...
require (
	...
	github.com/lihongjie0209/microservice-platform-go v0.9.10
	github.com/lihongjie0209/platform-protos v0.39.0
